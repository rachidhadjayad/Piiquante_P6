...
// on hash le mot de passe de façon asynchrone, on execute 10 le nombre de fois l'algorithme de hashage
                ...
                .then(valid => {
                    ...
                    res.status(200).json({
                        ...
                        token: jwt.sign(
                            { userId: user._id },
                            'RANDOM_TOKEN_SECRET',
// on ajoute un argument de configuration qui expire au bout de 24 heures
                            { expiresIn: '24h' }
                        )
                    });
                })
